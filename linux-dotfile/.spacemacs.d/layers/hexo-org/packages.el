;;; packages.el --- hexo-org Layer packages File for Spacemacs
;;
...
(setq hexo-org-excluded-packages '())

;; For each package, define a function hexo-org/init-<package-name>
;;


(defun hexo-org/init-org-caldav ()
  (use-package org-caldav
    ))

(defun hexo-org/init-org-mac-link  ()
  (use-package org-mac-link
    :defer t
    :init (add-hook'org-mode-hook (lambda () (require 'org-mac-link)))
    ))

(defun hexo-org/init-org-octopress ()
  (use-package org-octopress
    ...
    (define-key org-octopress-summary-mode-map "w" 'hexo-org/hexo-org-new-open-post)
...
(defun hexo-org/init-uimage ()
  (use-package uimage
    :defer t
    ))

(defun hexo-org/init-realgud ()
  (use-package realgud
    :defer t
    :init (load-library "realgud")
    ))

(defun hexo-org/init-erc-colorize ()
  (use-package colorize
    :defer t
    :init (add-hook 'erc-mode-hook 'erc-colorize-mode)
    ))
(defun hexo-org/init-hl-sexp ()
  (use-package hl-sexp
    :defer t
    :init
    (progn
...
(defun hexo-org/post-init-aggressive-indent ()
  (progn
    (add-hook 'emacs-lisp-mode-hook #'aggressive-indent-mode)
    (add-hook 'css-mode-hook #'aggressive-indent-mode)
    ))

(defun hexo-org/init-fcitx  ()
  (use-package fcitx
    :defer t
    :init
...
(defun hexo-org/post-init-org-bullets ()
  (setq org-bullets-bullet-list '("☰" "☷" "⋗" "⇀")))

(defun hexo-org/post-init-org ()
  ...
  (setq org-agenda-custom-commands
        '(
          ...
          ("pl" tags-todo "PROJECT+DREAM+CATEGORY=\"hexo-org\"")
          ("W" "Weekly Review"
...
(defun hexo-org/post-init-elfeed ()
